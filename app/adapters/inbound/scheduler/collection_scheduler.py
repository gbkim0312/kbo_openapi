...
def create_scheduler(
    use_case: CollectGamesUseCase, record_use_case: CollectRecordsUseCase | None = None
) -> AsyncIOScheduler:
    ...
    scheduler.add_job(collect_records, CronTrigger(hour=0, minute=30, timezone=SEOUL))
